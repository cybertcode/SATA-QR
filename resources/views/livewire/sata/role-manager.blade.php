<div>
    ...
    <div x-data="{ show: @entangle('showCreatePermissionModal') }">
        <div x-show="show" x-cloak class="fixed inset-0 z-80 overflow-y-auto" role="dialog" aria-modal="true"
            ...
            <div class="flex min-h-full items-center justify-center p-4">
                <div class="card relative w-full max-w-md shadow-xl border border-default-200 rounded-xl"
                    x-show="show" x-transition:enter="transition ease-out duration-200"
                    x-transition:enter-start="opacity-0 scale-95 translate-y-4"
                    x-transition:enter-end="opacity-100 scale-100 translate-y-0"
                    x-transition:leave="transition ease-in duration-150"
                    ...
                    <div class="card-header">
                        <h3 id="modal-create-permission-title" class="font-semibold text-base text-default-800">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"
                                stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" class="size-4 me-1 align-text-bottom inline-block">
                                <rect width="18" height="11" x="3" y="11" rx="2" ry="2" />
                    ...
                    <form wire:submit="storePermission">
                        <div class="card-body space-y-4">
                            <div>
                                ...
                                <input type="text" wire:model="permissionName"
                                    class="form-input font-mono @error('permissionName') border-danger @enderror"
                                    placeholder="modulo.accion (ej: reports.export)" autofocus>
                                @error('permissionName')
                                    <p class="text-danger text-xs mt-1">{{ $message }}</p>
                                @enderror
                                <p class="text-default-400 text-xs mt-1.5">
                        ...
                        <div class="card-footer flex items-center justify-end gap-2">
                            ...
                            <button type="submit" class="btn bg-success text-white inline-flex items-center gap-1"
